...
| Channel Supervisor answer/status + first Kilo child workflow | `src/config.ts`, `.env.example`, `src/mastra/index.ts`, `src/mastra/channels/**`, smallest required storage/migration paths, focused tests | T804 |
